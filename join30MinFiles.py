    ...
    if filename.endswith(".mp3"): 
        ...
        for testfile in os.listdir(directory):
            if target_file in testfile and testfile.endswith(".mp3"):
                ...
                os.system("ffmpeg -y -ss 00:00:00 -t 00:30:00 -i " + filepath + " -acodec copy " + outputfile)
                #Now concatenate first file to second
                os.system("echo \"file '" + outputfile + "'\nfile '" + secondfile + "'\" > /home/ubuntu/filelist.txt")
                os.system("ffmpeg -y -f concat -safe 0 -i /home/ubuntu/filelist.txt -c copy " + directory + fileyear + filemnth + filedate + "_" + filehour + "00_joined.mp3")